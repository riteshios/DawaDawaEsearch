...
extension ChangeEmailVC{
    ...
    func setuplanguage(){
        lblChangeEmail.text = LocalizationSystem.sharedInstance.localizedStringForKey(key: "Change Email", comment: "")
        lblSubheading.text = LocalizationSystem.sharedInstance.localizedStringForKey(key: "Enter new email address for your account", comment: "")
        txtFieldEmail.floatingLabelText = LocalizationSystem.sharedInstance.localizedStringForKey(key: "Enter new email address ", comment: "")
        txtFieldEmail.placeholder = LocalizationSystem.sharedInstance.localizedStringForKey(key: "Enter new email address ", comment: "")
