...
struct Notifications {
    ...
    static let karabicentervalidphoneemail      =  "الرجاء إدخال رقم هاتف / عنوان بريد إلكتروني صالح"
    ...
    static let karEnterEmail                    =  "الرجاء إدخال اسم المستخدم البريد الالكتروني"
    static let kEnterValidEmail                 =  "Please Enter Valid Email Id"
    static let karEnterValidEmail               =  "الرجاء إدخال البريد الإلكتروني الصحيح"
    static let kName                            =  "Please Enter  Name"
    static let Kimage                           =  "Please Select Image"
    static let kPassword                        =  "Please Enter Password"
    static let karPassword                      =  "الرجاء إدخال كلمة المرور"
    ...
    static let karValidPassword                 =   "يجب أن تحتوي كلمة المرور على 8 أحرف على الأقل ، وحرف كبير واحد ، وحرف صغير واحد بما في ذلك الأرقام والأحرف الخاصة"
    static let kConfirmPassword                 =  "Please Enter Confirm Password"
    static let karConfirmPassword               =  "الرجاء إدخال تأكيد كلمة المرور"
    ...
    static let karMatchPassword                 =  "كلمة المرور وتأكيد كلمة المرور غير متطابقين"
